...
public class DuenoDAO {
    ...
    public void agregarDueno(Dueno dueno) {
        String sql = "INSERT INTO dueno(nombre_completo, documento_identidad, direccion, telefono, email, contacto_emergencia) VALUES (?,?,?,?,?,?)";
        try (Connection conn = getConnection();
    ...
    public void agregarDueno(com.happyfeet.model.Dueno dueno) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
}